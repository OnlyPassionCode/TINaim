...
function CartItem({item, removeFromCart, incrementItem, decrementItem}: CartItem){
    ...
    <div className="flex items-center gap-4">
        ...
        <div className="w-full">
            <h3 className="text-base font-semibold text-gray-800">{item.getName()}</h3>
            <h6 className="text-sm text-gray-800 font-bold cursor-pointer mt-0.5">{item.getTotalPrice()}€</h6>
            ...
            <div className="flex gap-4 mt-4">
                ...
                <div>
                    <button type="button"
                        ...
                        <svg onClick={() => decrementItem(item)} xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 124 124">
                            <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" data-original="#000000"></path>
                        </svg>

                        <span className="mx-2.5">{item.getAmount()}</span>
                        <svg onClick={() => incrementItem(item)} xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 42 42">
                            <path d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" data-original="#000000"></path>
                        </svg>
                    </button>
                </div>

                <div className="ml-auto" onClick={() => removeFromCart(item)}>
