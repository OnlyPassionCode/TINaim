function Footer(){
    return (
        <footer className="xl:w-[calc(100%-325px)] mt-5 shadow bg-gray-900">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span className="block text-sm sm:text-center text-gray-400">© 2024 <a href="https://kevin-vanwassenhove.com/" className="hover:underline" target="_blank">Vanwassenhove Kevin</a>. Tout droit réservé.</span>
            </div>
        </footer>
    );
}
